        ...
        <div class="h-md lg-h-auto overflow-auto">
          ...
          <div class="text-xs text-gray-600 space-y-2 mt-6">
            ...
            <div>
              ...
              <div>是的，默认使用最新的gpt-4-turbo(gpt-4-0125-preview)模型，它的知识库截止2023年4月，但你问它是GPT几的时候有可能它并不知道自己是GPT4，可以用一些经典逻辑题区分，如：爸爸妈妈结婚为什么没有邀请我？ 如果能回答到结婚时还没有出生就是GPT4, GPT3.5是回答不到这个点的</div>
            </div>

            <div>
              <div class="font-bold text-gray-700">2.为什么字数一下子消耗完了</div>
              <div>非必要，请每个问题开新对话单独提问！连续对话时为了能理解上下文，每次提问都需要带上前面所有的内容，所以前面内容会重复计算字数; 提问和回答都会计算字数</div>
            </div>
